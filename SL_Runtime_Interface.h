...
namespace RMF {
	...
	public: 
		...
		// Constructor for object (e.g. class) with parameter instansiaton 
	...
	/* size resize max_size reserve capacity shrink_to_fit  clear insert emplac erase push_back, swap	*/
